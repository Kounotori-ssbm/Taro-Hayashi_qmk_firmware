...
const rgblight_segment_t PROGMEM upper_layer[] = RGBLIGHT_LAYER_SEGMENTS( {7, 1, HSV_RED} );
const rgblight_segment_t PROGMEM util_layer[] = RGBLIGHT_LAYER_SEGMENTS( {43, 4, HSV_CORAL}, {49, 4, HSV_CORAL}, {55, 4, HSV_CORAL} );
